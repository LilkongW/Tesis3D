...
def main():
    ...
    VIDEO_FOLDER_PATH = r"C:\Users\Victor\Documents\Tesis3D\Videos\Experimento_1\prueba\ROI_videos_640x480"  # <-- RUTA DE VIDEOS
    
    # Carpeta donde se guardarán los archivos CSV generados
    CSV_OUTPUT_PATH = r"C:\Users\Victor\Documents\Tesis3D\Data\prueba_data"  # <-- RUTA DE SALIDA DE CSV
